...
function commandIs(str, msg){
    return msg.content.toLowerCase().startsWith('q' + str);
}
...
:mosque: qquran 2  :   سورة البقرة كاملة - القارئ الحاج ميثم التمار (QURAN)

:mosque: qquran 3  :   القرآن الكريم كامل بصوت الشيخ عبد الرحمن السديس وسعود الشريم 

:mosque: .quran 4  :   القرآن الكريم كامل بصوت الشيخ المعيقلي

:mosque: qstop     : لـ أيقاف تشغيل البوت `)
}
